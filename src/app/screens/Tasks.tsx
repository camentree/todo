...
export function Tasks() {
  ...
  const editorScreen = editing && isPhone;
  ...
  const editor = editing ? (
    <Editor key={route.id ?? "new"} task={editingTask} onCommit={reveal} onClose={close} onDelete={() => editingTask && askDeleteEditing(editingTask)} />
  ) : null;
