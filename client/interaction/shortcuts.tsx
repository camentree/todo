...
export type ShortcutAction = "close" | "down" | "up" | "fold" | "unfold" | "select" | "complete" | "edit" | "delete" | "today" | "thread" | "add" | "help";
...
export const shortcuts: { keys: string[]; action: ShortcutAction; label: string }[] = [
  ...
  { keys: ["h"], action: "fold", label: "fold" },
  { keys: ["l"], action: "unfold", label: "unfold" },
